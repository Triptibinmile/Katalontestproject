...
WebUI.click(findTestObject('Object Repository/Page_Account Login/div_Password  Forgotten Password'))

WebUI.click(findTestObject('Object Repository/Page_Account Login/body_Top categories        Components     C_e3691b'))
...
WebUI.click(findTestObject('Object Repository/Page_Components/label_In stock'))
