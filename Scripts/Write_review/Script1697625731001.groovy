...
WebUI.click(findTestObject('Object Repository/Page_Your Store/a_SHOP NOW'))

WebUI.click(findTestObject('Object Repository/Page_Your Store/img_170.00_lazy-load'))

WebUI.click(findTestObject('Object Repository/Page_iMac/label_5'))

WebUI.setText(findTestObject('Object Repository/Page_iMac/textarea_Write a review_text'), 'Testing tetste jahsjdhsad ksakjsadkjkjdskjds kjdskjkjdsakjdsa lkjsakjkjdskjdsa kjsakjkjdsakjdsa kjsadkjdsakjdsakjaskjksadjh nhjdahkjhadjkjjk')
