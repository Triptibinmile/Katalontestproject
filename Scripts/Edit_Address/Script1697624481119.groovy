...
WebUI.setText(findTestObject('Object Repository/Page_Address Book/input_Company_company'), 'binmile techno')

WebUI.click(findTestObject('Object Repository/Page_Address Book/input_Back_btn btn-primary'))

WebUI.click(findTestObject('Object Repository/Page_Address Book/i_Your address has been successfully update_81df92'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Address Book/div_Your address has been successfully updated'))
