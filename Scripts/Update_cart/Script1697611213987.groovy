...
WebUI.click(findTestObject('Object Repository/Page_Account Login/form_E-Mail Address    Password  Forgotten _f85c1a'))
...
WebUI.click(findTestObject('Object Repository/Page_My Account/use'))

WebUI.click(findTestObject('Object Repository/Page_My Wish List/i_146.00_fas fa-cart-plus'))

WebUI.click(findTestObject('Object Repository/Page_My Wish List/a_View Cart'))

WebUI.click(findTestObject('Object Repository/Page_Account Login/input_Forgotten Password_btn btn-primary'))

WebUI.setText(findTestObject('Object Repository/Page_Shopping Cart/input_Product 1_quantity31843'), '2')

WebUI.doubleClick(findTestObject('Object Repository/Page_Shopping Cart/input_Product 1_quantity31843'))
