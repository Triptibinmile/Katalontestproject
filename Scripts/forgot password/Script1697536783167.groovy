...
WebUI.click(findTestObject('Object Repository/Page_My Account/a_Password'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Change Password/input_Password_password'), 'RigbBhfdqOBGNlJIWM1ClA==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Change Password/input_Password Confirm_confirm'), 'RigbBhfdqOBGNlJIWM1ClA==')
